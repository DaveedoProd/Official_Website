...
const Testt = () => {
    ...
    return (
        <div className='carousel-container2'>
            ...
            {/* Slider version - will be hidden on mobile */}
            <div className='w-5/6 m-auto hide'>
                <div className='mt-20'>
                    <Slider {...settings}>
                        {data.map((d, index) => (
                            <a
            ...
            {/* Column version - will show on mobile */}
            <div className='w-5/6 m-auto hide hide1'>
                <div className='mt-20'>
                    <div className='flex flex-col gap-4'>
                        {data.map((d, index) => (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className='card bg-white text-black rounded-xl overflow-hidden'
                                onMouseEnter={() => setHoveredIndex(index)}
                                onMouseLeave={() => setHoveredIndex(null)}
                            >
                                <img
